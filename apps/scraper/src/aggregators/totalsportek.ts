...
function absolutise(href: string | undefined, pageUrl: string): string | null {
...
function inferQuality(text: string): string | null {
...
function dedupeByUrl(links: StreamLink[]): StreamLink[] {
